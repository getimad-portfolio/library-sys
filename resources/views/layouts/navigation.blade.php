...
<nav x-data="{ open: false }" class="bg-white m-2 rounded-md fixed top-0 left-0 w-1/4 h-[calc(100vh-1rem)] shadow-2xl shadow-gray-100 border">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between">
            <div class="w-full">
                <!-- Logo -->
                <div class="shrink-0 grid place-items-center my-12">
                ...
                <!-- Navigation Links -->
                <div class="hidden sm:flex sm:flex-col w-full gap-6">
                    @if (auth()->check() && auth()->user()->role->value === UserRole::ADMIN->value)
                        <x-nav-link :active="request()->routeIs('admin.dashboard')">
                            <a href="{{ route('admin.dashboard') }}" class="py-3 flex gap-3 items-center w-full">
                    ...
                    @else
                        <x-nav-link :active="request()->routeIs('librarian.dashboard')">
                            <a href="{{ route('librarian.dashboard') }}" class="py-3 flex gap-3 items-center w-full">
                                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
                                </svg>
                                {{ __('Dashboard') }}
                    ...
                    <x-sub-nav-group>
                        ...
                        <x-slot name="slot">
                            <x-nav-link :active="request()->routeIs('members.*')" class="flex items-center justify-between">
                                <a href="{{ route('members.index') }}" class="flex gap-3 items-center w-full py-3">
                                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                            ...
                            <x-nav-link :active="request()->routeIs('books.*')" class="flex items-center justify-between">
                                <a href="{{ route('books.index') }}" class="flex gap-3 items-center w-full py-3">
                                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                    ...
                    @if (auth()->check() && auth()->user()->role->value === UserRole::ADMIN->value)
                        <x-nav-link :active="request()->routeIs('logs.*')">
                            <a href="{{ route('logs.index') }}" class="py-3 flex gap-3 items-center w-full">
                                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                    ...
                    <x-nav-link :active="request()->routeIs('profile.*')">
                        <a href="{{ route('profile.edit') }}" class="py-3 flex gap-3 items-center w-full">
                            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                        ...
                        <x-nav-link
                            ...
                            class="w-full text-red-500 hover:text-red-700 hover:bg-red-100 transition-colors duration-200 ease-in-out"
                        >
                            <a href="{{ route('logout') }}" class="py-3 flex gap-3 items-center w-full">
                                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
